# Adapted from DO-TEARS (Xue et al.)
# Original repo: https://github.com/asxue/dotears
# MIT License
...
#                 self.original_variances[k] = v.var(axis=0)
    ...
    def estimate_exogenous_variances(self, data):
        ...
        for k, v in data.items():
            ...
            j = int(k.split("_")[0])  # <-- changed
            variances[j] = v.var(axis=0)[j]

        variances[variances == 0] = 1e-8  # <-- added to combat 0 variance (wrong?)
        return variances
